...
Run the trace autonomously using the `startup-harness:trace` skill's behavioral contract.
...
- Use `Agent(subagent_type="startup-harness:explore", model="haiku")` for brownfield codebase exploration (Phase 1)
