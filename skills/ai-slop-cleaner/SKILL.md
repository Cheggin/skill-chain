...
- Good fit: `startup-harness:ai-slop-cleaner skills/ralph/SKILL.md skills/ai-slop-cleaner/SKILL.md`
...
- `/startup-harness:ai-slop-cleaner <target>`
- `/startup-harness:ai-slop-cleaner <target> --review`
- `/startup-harness:ai-slop-cleaner <file-a> <file-b> <file-c>`
